...
This mock simulates the gemini CLI behavior for integration tests.
...
Output format:
    {"session_id": "mock-session", "response": "...", "stats": {...}}
"""
...
def main() -> int:
    ...
    if os.environ.get("MULTI_LLM_TEST_MODE") != "1":
        print(
            "ERROR: mock_gemini.py should only be used in test mode. "
        ...
        response_content = json.dumps([
            {
                "id": "mock-gemini-1",
                "type": "suggestion",
                "description": "Mock suggestion from gemini",
                "importance": "LOW",
                "location": "mock_file.py:20"
            }
        ])
